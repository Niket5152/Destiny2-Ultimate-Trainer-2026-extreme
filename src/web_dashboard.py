...
log = logging.getLogger("Destiny2-Ultimate-Trainer-2026-extreme.WebUI")

class WebUI:
    def __init__(self, trainer: TrainerCore, port=4207):
...
<html>
<head>
    <title>Destiny2-Ultimate-Trainer-2026-extreme Dashboard</title>
    <style>
        body { background: #1a1a2e; color: #e67e22; font-family: sans-serif; }
...
<body>
    <h1>Destiny2-Ultimate-Trainer-2026-extreme</h1>
    <div id="features"></div>
    <script>
