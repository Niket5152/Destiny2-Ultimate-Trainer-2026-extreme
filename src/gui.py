...
from src.trainercore import TrainerCore

log = logging.getLogger("Destiny2-Ultimate-Trainer-2026-extreme.GUI")

class TrainerGUI(ctk.CTk):
    def __init__(self, trainer: TrainerCore):
        super().__init__()
        self.trainer = trainer
        self.title("Destiny2-Ultimate-Trainer-2026-extreme 1.3.0")
    ...
    def create_widgets(self):
        ctk.CTkLabel(self, text="Destiny2-Ultimate-Trainer-2026-extreme", font=("Segoe UI", 24, "bold")).pack(pady=20)
...
def create_tray_icon(gui):
    img = Image.new('RGB', (64,64), color=(230, 126, 34))
    ...
    return pystray.Icon("trainer", img, "Destiny2-Ultimate-Trainer-2026-extreme", menu)
